...
export const webDevTechStacks: TechStackModel[] = [
	reactTechStack,
	typescriptTechStack,
	sassTechStack,
	nodeTechStack,
...
export const pythonTechStack: TechStackModel = {
	name: 'Python',
	description:
		"As the first language I learnt, Python has been my go to scripting language ever since. Some examples of what I've used Python for are: building a compiler, creating Machine Learning Models (using PyTorch), used TCP sockets to communicate over the socket interface.",
	image: pythonImage
};
...
export const javaTechStack: TechStackModel = {
	name: 'Java',
	description:
		'In University Java was the main language I used for my projects. Projects involved using backend Java frameworks like Spring Boot, creating frontend apps with JavaFX, etc.',
	image: javaImage
};
export const cPlusPlusTechStack: TechStackModel = {
	name: 'C++',
	description:
		'In computer graphics courses I used C++ to crete ray tracing algorithms, use memory allocation, create mesh models, and much more! Learning a lower level language like this taught me a lot about data structures and how to write robust programs.',
