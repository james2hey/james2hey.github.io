...
export const lumosMobileProject: ProjectModel = {
    ...
    content: "I played a key role in createing a new mobile app for moviegoers to purchase tickets, concessions, and manage their loyalty accounts. This was a part of Vista's newest self-service sales channel offering, and will be going into production for multiple cinemas in 2022.",
}
