import {
    cSharpTechStack,
    dotNetTechStack,
    ionicTechStack, reactNativeTechStack,
    reactTechStack, reduxTechStack,
    sassTechStack, sqlTechStack,
    TechStackData,
    typescriptTechStack
} from "../tech-stacks/tech-stack-data";
...
export const lumosMobileProjectData: ProjectData = {
    name: 'Lumos Mobile',
...
export const archiesProjectData: ProjectData = {
...
export const circuitStatsProjectData: ProjectData = {
    name: 'Circuit Stats',
...
export const pipProjectData: ProjectData = {
    name: 'PiP IoT App',
    image: pipImage,
...
export const allProjectData: ProjectData[] = [lumosMobileProjectData, circuitStatsProjectData, archiesProjectData, pipProjectData];